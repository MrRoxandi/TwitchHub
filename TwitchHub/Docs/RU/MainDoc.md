...
Перед прочтением данной документаци и написании своих скриптов, **настоятельно** рекомендуется ознакомиться с [настройками](MainConfig.md) основго приложения:
...
| ---------- | ------------------------------------------------------------------------------------ | -------------------- | ---------- |
| `oncall`   | Lua функция, соотвествующая типу `kind`. [Прототипы](KIndPrototypes.md)              | -                    | +          |
| `kind`     | Тип события, которому соотвествует данная `LuaReaction`. [Список](KIndPrototypes.md) | -                    | +          |
