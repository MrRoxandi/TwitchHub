...
| `loggerlib`   | Библиотека позволяет отправлять `Log` сообщения в консоль и `log file`         | [DOC](Libs/LoggerLib.md.md) |
| `medialib`    | Библиотека позволяет взаимодействовать с аудио/видое файлами                   | [DOC](Libs/HardwareLib.md)  |
| `pointslib`   | Библиотека позволяет взаимодействовать с системой очков                        | [DOC](Libs/HardwareLib.md)  |
